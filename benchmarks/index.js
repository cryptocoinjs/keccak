...
new benchmark.Suite('Buffer 0bytes')
  .add('Bindings (current)', () => cbindings('sha3-256').digest('hex'))
  .add('Pure JS (current)', () => cpurejs('sha3-256').digest('hex'))
  .add('Pure JS (sha3)', () => obindings.SHA3(256).digest('hex'))
...
new benchmark.Suite('Buffer 10MiB')
  .add('Bindings (current)', () => cbindings('sha3-256').update(buffer10mib).digest('hex'))
  .add('Pure JS (current)', () => cpurejs('sha3-256').update(buffer10mib).digest('hex'))
